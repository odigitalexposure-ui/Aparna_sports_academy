        ...
        <section className="w-full bg-gradient-to-b from-white to-purple-50 py-16">
            ...
            >
                <h2 className="text-2xl md:text-4xl font-extrabold text-purple-700">
                    Experience Our Training Environment
                </h2>

                <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
                    A glimpse of our professional coaching, sports facilities, and real
                    training atmosphere designed to build future champions.
                </p>
            </motion.div>
            ...
            <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
                ...
                >
                    ...
                    <p className="text-gray-600 mt-4 text-lg">
                        Train under expert coaches in Cricket, Football, and Athletics.
                        We focus on skill development, discipline, and real match
                        experience to build future champions.
                    </p>
